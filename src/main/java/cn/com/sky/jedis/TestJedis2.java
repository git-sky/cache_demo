...
public class TestJedis2 {
	...
	public static void main(String[] args) {
		TestJedis2 test = new TestJedis2();
		test.testHash();
	}
	...
	public void testHash() {
		...
		try {
			...
			System.out.println(jedis.hgetAll("position"));
			System.out.println(jedis.hget("position", "660105827535166")); // 批量获取指定的值
			System.out.println(jedis.hkeys("position"));

			Set<String> sns = jedis.hkeys("position");
			for (String sn : sns) {
				System.out.println(jedis.hget("position", sn)); // 批量获取指定的值
			}
